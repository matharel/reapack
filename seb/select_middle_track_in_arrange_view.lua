--[[
 * ReaScript Name: Select middle track in arrange view
 * Description: 
 * Instructions: Run
 * Screenshot:
 * Author: matharel
...
function Main()
    ...
    local middleTrack = nil
    -- arrangeBottom correspond à la hauteur du viewport (le haut de l'écran étant à zéro)
    local arrangeHeight = arrangeBottom - extraHeight
    local center = arrangeHeight / 2
    ...
    for i = reaper.CountTracks(0)-1, 0, - 1 do
        ...
        if trackTop < center and trackBottom > center then
                middleTrack = track
                break
        end
    end
    reaper.SetOnlyTrackSelected(middleTrack)
end
